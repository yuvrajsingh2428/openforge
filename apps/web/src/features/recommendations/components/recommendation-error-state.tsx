...
export function RecommendationErrorState({ message, onRetry }: RecommendationErrorStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <p className="text-sm text-muted-foreground max-w-sm mb-4">
        {message ?? "We encountered an error generating recommendations. This might be a temporary issue."}
      </p>
      {onRetry && (
        <button
          onClick={onRetry}
