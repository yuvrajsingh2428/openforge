...
export function RepositoryEmptyState({ hasFilters, onReset }: RepositoryEmptyStateProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      ...
      <p className="text-sm text-muted-foreground max-w-sm mb-4">
        {hasFilters
          ? "No repositories match your current filters. Try adjusting your search or filter criteria."
          : "No curated repositories are available at the moment."}
      </p>
      {hasFilters && onReset && (
        <button
          onClick={onReset}
