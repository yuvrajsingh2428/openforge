...
/**
 * @openapi
 * /api/repositories/{owner}/{repo}/issues/{number}/mentor/checklist:
 *   get:
 *     summary: Retrieve derived review checklist
 *     responses:
 *       200:
 *         description: Success
 */
export async function GET(
  ...
  try {
    ...
    return standardResponse(session.reviewChecklist);
  } catch (error: any) {
    console.error("Mentor Checklist error:", error);
